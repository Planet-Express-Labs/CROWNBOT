...
from io import BytesIO
from CROWNBOT.config import SUBSCRIPTION_KEY, CONTENT_MODERATOR_ENDPOINT
...
if __name__ == "__main__":
    sys.path.append(os.path.abspath(os.path.join(__file__, "../../../../PycharmProjects/zoidberg/cogs", "..", "..")))
